                ...
                <div className="flex items-center justify-center min-h-screen">
                    <div className="space-y-5 w-11/12 lg:w-1/2 bg-white shadow-lg p-5 lg:p-10 rounded-lg">
                        ...
                        <p className="text-center text-sm lg:text-base">
                            You will watch a video on the next page and determine whether it is AI-generated or an original video. Prior to this, you were shown a comparison video featuring both AI-generated and original content to help you understand the differences.
